...
import {
  LayoutDashboard, ShoppingCart, Tag, Package,
  LogOut, Menu, X, Bell, TrendingUp,
} from 'lucide-react'
...
const navItems = [
  ...
  { to: '/dashboard/vente', label: 'Nouvelle vente', icon: ShoppingCart },
        ...
        <div className="flex items-center justify-between h-16 px-6 border-b border-gray-700">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-primary-400 text-xs truncate max-w-[120px]">
                {user?.company?.name ?? 'Ma boutique'}
              </p>
            </div>
          </div>
          <button
